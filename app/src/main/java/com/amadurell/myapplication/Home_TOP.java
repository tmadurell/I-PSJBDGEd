...
import com.amadurell.myapplication.databinding.HomeNTopBinding;

import java.util.List;

public class Home_TOP extends Fragment {

    HomeNTopBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = HomeNTopBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.llupa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_home_TOP_to_cerca);
            }
        ...
        binding.genero.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_home_TOP_to_home_Genere);
            }
        ...
        binding.novetats.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_home_TOP_to_home_n);
            }
